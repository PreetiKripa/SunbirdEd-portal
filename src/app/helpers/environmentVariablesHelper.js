...
let devEnvVariables = {
  ...
  sunbird_portal_base_url: 'https://dev.sunbirded.org',
  SUNBIRD_PORTAL_BASE_URL: 'https://dev.sunbirded.org',
  sunbird_data_product_service: env.sunbird_data_product_service || 'https://preprod.ntp.net.in/',
  ...
  TELEMETRY_SERVICE_LOCAL_URL: env.sunbird_telemetry_service_local_url || 'https://dev.sunbirded.org/',
  ...
  sunbird_anonymous_device_register_api: env.sunbird_anonymous_device_register_api || 'https://dev.sunbirded.org/api/api-manager/v2/consumer/portal_anonymous/credential/register',
  sunbird_loggedin_device_register_api: env.sunbird_loggedin_device_register_api || 'https://dev.sunbirded.org/api/api-manager/v2/consumer/portal_loggedin/credential/register',
  sunbird_kong_refresh_token_api: env.sunbird_kong_refresh_token_api || 'https://dev.sunbirded.org/auth/v1/refresh/token',

  // Device register API for anonymous users
  sunbird_anonymous_register_token: env.sunbird_anonymous_register_token || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJXMWNVUlQ0bE83OGtzZ28zT0I1RWFsWXNsU1NBd092RSJ9.-jPsekWpGUpXutzaVscim_08J3_kWXBL2O38UbZTkog',
  // Device register API for logged in users
  sunbird_loggedin_register_token: env.sunbird_loggedin_register_token || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJmTEU1NzFoaDdEUDhxUzBEaWlqS1Y5WE1DbDZGclkzbiJ9.TW2sfq9mYp9uXW0qDjCXygcZbwUA0TTZdlhWC-cMVS0',
...
"{\"cookie\":{\"originalMaxAge\":86399999,\"expires\":\"2021-11-12T13:23:36.669Z\",\"httpOnly\":true,\"path\":\"/\"},\"context\":\"[{\\\"sbIdentifier\\\":\\\"c4320769-13cd-43a9-bc73-c10eeac197a0\\\",\\\"sbType\\\":\\\"group\\\",\\\"cid\\\":\\\"45\\\"}]\",\"user\":\"{\\\"userId\\\":{\\\"uid\\\":\\\"12\\\"},\\\"userSlug\\\":\\\"content_creator_tn3941\\\",\\\"userName\\\":\\\"content_creator_tn3941\\\"}\"}"